                            ...
                            <div class="table-wrap">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            <input type="text" name="nik" class="form-control" placeholder="No. Identitas" value="<?= $users['nik']  ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 control-label">No. Hp/WA</label>
                                        <div class="col-md">
                                            <input type="text" name="no_hp" class="form-control" placeholder="No. Hp/WA" value="<?= $users['no_hp']  ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
